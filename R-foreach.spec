...
Version  : 1.4.8
Release  : 48
URL      : https://cran.r-project.org/src/contrib/foreach_1.4.8.tar.gz
Source0  : https://cran.r-project.org/src/contrib/foreach_1.4.8.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581285008
