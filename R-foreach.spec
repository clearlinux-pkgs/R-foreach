...
Version  : 1.4.7
Release  : 47
URL      : https://cran.r-project.org/src/contrib/foreach_1.4.7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/foreach_1.4.7.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571832411
